@push('scripts')
    ...
    <script>
        ...
        function populateFinalInputDataBL() {
            $('#form_outbound_finalize').append(`
                <input type="hidden" class="final-input-hidden" id="paid_thru_date" name="paid_thru_date" value="${$('#paid_thru_date_bl').val()}">
                <input type="hidden" class="final-input-hidden" id="master_bl_number" name="master_bl_number" value="${$('#input_master_bl_number').val()}">
                <input type="hidden" class="final-input-hidden" id="master_bl_date" name="master_bl_date" value="${$('#input_master_bl_date').val()}">
                <input type="hidden" class="final-input-hidden" id="job_type" name="job_type" value="${'OVER BRENGEN'}">
        ...
        function populateFinalInputDataContainer() {
            $('#form_outbound_finalize').append(`
                ...
                <input type="hidden" class="final-input-hidden" id="job_type" name="job_type" value="${'DOMESTIC'}">
                <input type="hidden" class="final-input-hidden" id="order_type" name="order_type" value="${'OUTBOUND'}">
                <input type="hidden" class="final-input-hidden" id="total_amount" name="total_amount" value="">
            `);
        }
