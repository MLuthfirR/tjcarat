<div class="row px-0 px-lg-3 font-14">
    ...
    <div class="col-md-7">
        <div class="bg-white p-3 mb-3 shadow shadow-sm import-section" style="border-radius: 8px">
            <div class="row m-0">
                <div class="col-12 m-0 p-0 align-self-center">
                    <div class="row">
                    ...
                    <div class="collapse doc-collapse row" id="document-input-collapse">
                        @foreach ($input_sppb_fields as $field)
                            @include('layouts.input_form')
                        @endforeach
                        <div class="col-12 d-flex justify-content-center">
                            <button type="button" class="btn btn-outline-primary" onclick="checkSPPBDocument()">Check SPPB</button>
                        </div>
                    </div>
                    <div class="collapse doc-collapse row" id="document-summary-collapse">
                        ...
                        <div class="col-12">
                            <h5 class="mb-0 text-secondary font-14">SPPB Date</h5>
                            <h5 class="text-dark font-weight-medium input-text sppb-date-text">476236</h5>
                        </div>
                        <div class="col-12 d-flex justify-content-center">
                    ...
                    <div class="collapse doc-collapse row" id="document-failed-collapse">
                        <div class="col-12 text-center">
                            <div class="my-3 mx-4">
                                ...
                                <h5 class="text-dark font-14">Failed to fetch documents data related to SPPB.
                                    Please make sure SPPB No. and Date is correct, documents are registered, and try again.</h5>
                            </div>
                            <div class="mb-3">
                                <a href="javascript:" onclick="toggleInputSPPBDocument()">Retry Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="shadow-sm bg-white mb-3 container-section" style="border: 1px dashed #ddd;border-radius: 8px">
                ...
                <a href="#add-container-to-order" class="collapsed"data-toggle="collapse" aria-controls="add-container-to-order">
                    <div class="row align-items-center">
                        <div class="col-10 col-md-11">
                            <h5 class="mb-0 text-dark font-weight-medium">Input Additional Container</h5>
                        </div>
            ...
            <div class="collapse col-12 px-3" id="add-container-to-order">
                <div class="row px-3">
                    @foreach ($input_additional_container_fields as $field)
                        @include('layouts.input_form')
                    @endforeach
    ...
    <div class="col-12">
        <div class="shadow-sm bg-white mb-3 cargo-section" style="border: 1px dashed #ddd;border-radius: 8px">
            <div class="px-4 py-3 align-self-center">
                <a href="#add-cargo-to-order" class="collapsed"data-toggle="collapse" aria-controls="add-cargo-to-order">
                    <div class="row align-items-center">
                        <div class="col-10 col-md-11">
                            <h5 class="mb-0 text-dark font-weight-medium">Input Cargo</h5>
                        </div>
                        <div class="col-2 col-md-1 text-center collapse-arrow">
                            <i class="icon text-secondary" data-feather="chevron-down"></i>
                        </div>
            ...
            <div class="collapse col-12 px-3" id="add-cargo-to-order">
                <div class="row px-3">
                    <div class="col-sm-6">
                        <div class="row">
                            @foreach ($input_cargo_fields as $field)
                                @include('layouts.input_form')
                            @endforeach
                        </div>
                    </div>
                    <div class="col-sm-6">
                        {{-- TODO: Function --}}
                        <button type="button" class="btn btn-sm btn-outline-primary mt-4 mb-2" onclick="">Check Available Qty</button>
                        <p class="font-14 text-dark mb-3 ml-1">Available Qty: <span class="font-weight-medium">23</span></p>
                    </div>
                    <div class="col-12 d-flex mb-4 justify-content-center">
                        {{-- TODO: Function --}}
                        <button type="button" class="btn btn-outline-primary" onclick="">+ Add Cargo to Order</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <form class="container-section" id="container_list_form" action="" method="post">
                    ...
                    <table class="table table-required no-wrap v-middle mb-0">
                        <thead>
                            <tr class="border-0">
                                ...
                                <th class="border-0 font-14 font-weight-medium text-muted">Warehouse
                                </th>
            ...
            <div class="d-flex mt-5 justify-content-center">
                <button type="button" class="btn btn-primary step2-btn" onclick="finalizeContainerOrder()" disabled>Calculate Price and Finalize Order</button>
            </div>
            <div class="d-flex mt-2 justify-content-center">
                <button type="button" class="btn btn-outline-danger border-0" onclick="resetButton()">Reset</button>
            </div>
        </form>
        <form class="cargo-section" id="cargo_list_form" action="" method="post">
            <h6 class="text-dark mb-0">Cargo List<span class='text-danger'>*</span></h6>
            <div class="text-secondary font-italic font-12 mb-2 input-text" id="cargo-list-note"></div>
            <div class="shadow bg-white" style="max-height: 425px; overflow: auto; border-radius: 8px;">
                <div class="table-responsive" id="cargo-list-table-container">
                    <table class="table table-required no-wrap v-middle mb-0">
                        <thead>
                            <tr class="border-0">
                                <th class="border-0"></th>
            ...
            <div class="d-flex mt-5 justify-content-center">
                <button type="button" class="btn btn-primary step2-btn" onclick="finalizeCargoOrder()" disabled>Calculate Price and Finalize Order</button>
            </div>
            <div class="d-flex mt-2 justify-content-center">
                <button type="button" class="btn btn-outline-danger border-0" onclick="resetButton()">Reset</button>
            </div>
...
@include('customer.pages.warehouse.create_booking.outbound.outbound_select.js_outbound_select')
