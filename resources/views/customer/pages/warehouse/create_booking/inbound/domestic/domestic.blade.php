    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-xs-12 col-md-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Domestic</h3>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('warehouse.booking.create.inbound.domestic') }}">Domestic</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 px-0 px-lg-3">
                    <div class="card my-4 px-0 px-lg-3">
                        <div class="card-body">
                            ...
                            @include('customer.pages.warehouse.create_booking.inbound.domestic.cargo_domestic', [
                                'required' => true,
                            ])
                        </div>
                    </div>
...
@include('customer.pages.warehouse.create_booking.js_inbound')
